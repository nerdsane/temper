# ADR-0178: Unsupported safety invariants fail closed
...
- Related:
  ...
  - ARN-213: Verification cascade treats unsupported safety invariants as passing
...
- simulation and property testing treat an unsupported declaration as a standing
  violation when reached, so backend-only callers cannot paper over the gap.
...
3. Align direct symbolic, exhaustive, composite, simulation, and property evaluation

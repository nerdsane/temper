      ...
      <div className="max-w-[960px] mx-auto px-6 relative z-[2]">
        <ScrollReveal>
          ...
          <h2 className="text-[clamp(1.5rem,3vw,2rem)] font-serif tracking-[-0.02em] mb-4">
            Watch an Agent <em className="italic text-[var(--color-accent-teal)]">Grow.</em>
          </h2>
          <p className="text-base text-[var(--color-text-secondary)] max-w-[580px] mb-16 leading-[1.7]">
        ...
        <div className="flex gap-12 items-start max-[900px]:flex-col">
            ...
            {stories.map((story, i) => (
              <ScrollReveal key={i} animation="fade-up" delay={i * 100}>
                <div className="relative pl-6 border-l border-[var(--color-border)]">
                  <div className="absolute left-[-5px] top-0 w-[9px] h-[9px] rounded-full bg-[var(--color-accent-teal)]/40 border border-[var(--color-accent-teal)]/60" />
                  <p className="text-[15px] font-semibold text-[var(--color-text-primary)] mb-3">
                    {story.trigger}
                  </p>
                  <p className="text-[14px] text-[var(--color-text-secondary)] mb-3 leading-[1.7]">
                    {story.observation}
                  </p>
                  <p className="text-[14px] text-[var(--color-text-secondary)] mb-3 leading-[1.7]">
                    {story.action}
                  </p>
                  <p className="text-[14px] text-[var(--color-accent-teal)]/80 leading-[1.7]">
                    {story.result}
                  </p>
                </div>
              </ScrollReveal>
          ...
          <div className="flex-shrink-0 sticky top-[20vh] max-[900px]:relative max-[900px]:top-0 max-[900px]:w-full">
            <div className="w-[340px] max-[900px]:w-full max-[900px]:max-w-[380px] max-[900px]:mx-auto aspect-square bg-[var(--color-bg-elevated)] backdrop-blur-xl border border-[var(--color-border)] rounded-[3px] flex items-center justify-center relative corner-accents">
              <GrowthViz />
            </div>
          </div>
        </div>

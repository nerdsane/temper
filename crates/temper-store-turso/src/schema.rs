...
pub(crate) mod declaration_authority;
...
pub use query_plane::{
    ALTER_ENTITY_VECTOR_INDEX_VERSION_ADD_GENERATION, CREATE_ENTITY_CATALOG_STATUS_INDEX,
    CREATE_ENTITY_CATALOG_TABLE, CREATE_ENTITY_CATALOG_TYPE_INDEX,
    CREATE_ENTITY_FIELD_INDEX_LOOKUP, CREATE_ENTITY_FIELD_INDEX_STATUS,
    CREATE_ENTITY_FIELD_INDEX_TABLE, CREATE_ENTITY_KEY_INDEX_ENTITY, CREATE_ENTITY_KEY_INDEX_TABLE,
    CREATE_ENTITY_VECTOR_INDEX_ENTITY, CREATE_ENTITY_VECTOR_INDEX_PARTITION,
    CREATE_ENTITY_VECTOR_INDEX_TABLE, CREATE_ENTITY_VECTOR_INDEX_VERSION_TABLE,
    CREATE_VECTOR_INDEX_BACKFILL_WATERMARK, CREATE_VECTOR_RECONCILIATION_GENERATION_TABLE,
    SEED_ENTITY_VECTOR_INDEX_VERSION_TABLE,
};

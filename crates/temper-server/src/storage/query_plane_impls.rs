...
use temper_store_turso::{QueryProjectionUpsert as TursoQueryProjectionUpsert, TursoEventStore};
...
impl QueryPlaneStore for PostgresEventStore {
    ...
    async fn upsert_projection_if_source(
        ...
        self.upsert_query_projection_with_state_if_source(
            tenant,
            entity_type,
            entity_id,
            status,
    ...
    async fn remove_projection_if_source(
        ...
        self.remove_query_projection_if_source(tenant, entity_type, entity_id, source)
            .await
    }
    ...
    async fn clear_projection_dirty_if_source(
        ...
        self.clear_query_projection_dirty_if_source(tenant, entity_type, entity_id, source)
            .await
    }
    ...
    async fn remove_projection_if_exact(
        ...
        self.remove_query_projection_if_exact(
            tenant,
            entity_type,
            entity_id,
            status,
    ...
    async fn dirty_projection_entity_ids(
        ...
        self.dirty_query_projection_entity_ids(tenant, entity_type, limit)
            .await
            .map(Some)
    }
}
...
pub(super) fn to_turso_projection(
    projection: &QueryProjectionUpsert,

//! Lossless adapters from Postgres observation rows to backend-neutral rows.

use temper_store_turso::{
    ActionStats, AgentSummary, DesignTimeEventRow, EvolutionRecordRow, FeatureRequestRow,
    OtsQueuedTrajectoryRow, OtsTrajectoryRow, PolicyDenialPatternRow, TursoTrajectoryRow,
...
pub(super) fn pg_queued_ots_to_turso(

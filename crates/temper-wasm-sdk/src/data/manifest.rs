...
impl ModuleSdkManifest {
    ...
    pub fn compatible_action_nullability_widenings(
        ...
        for prior_entity in &self.entities {
            ...
            for prior_action in &prior_entity.actions {
                ...
                for prior_parameter in &prior_action.parameters {
                    let Some(candidate_parameter) =
                        candidate_action.parameters.iter().find(|parameter| {
                            parameter.canonical_name == prior_parameter.canonical_name
                        })
                    else {

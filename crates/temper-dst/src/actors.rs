//! Register platform system-entity handlers on [`SimActorSystem`].
...
/// Register one CatalogEntry actor.
...
/// Register one Collaborator actor.
...
/// Register `count` Project actors named `p-0` …
...
/// Register `count` Tenant actors named `t-0` …
...
/// Register `count` CatalogEntry actors named `cat-0` …
...
/// Register `count` Collaborator actors named `col-0` …
...
/// Register `count` Version actors named `v-0` …
...
/// Register one of each system entity type.

...
require_pattern "$ROOT/crates/temper-observe/src/otel/sampler.rs" "temper_trace_sampler_decisions_total" "trace sampler decision metric"
require_pattern "$ROOT/crates/temper-observe/src/otel/sampler.rs" "TEMPER_TRACE_DISPATCH_BACKGROUND_SAMPLE_PCT" "dispatch background trace budget flag"

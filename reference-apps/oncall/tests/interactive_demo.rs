...
fn interactive_full_triage_pipeline() {
    ...
    for (name, source) in [
        ...
        println!(
            "  {:<20} states={:<3} actions={:<3} invariants={}",
            name,
